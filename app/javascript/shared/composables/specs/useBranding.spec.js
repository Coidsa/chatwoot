...
describe('useBranding', () => {
  ...
  describe('replaceInstallationName', () => {
    it('should replace "Hupa" with installation name when both text and installation name are provided', () => {
      const { replaceInstallationName } = useBranding();
      const result = replaceInstallationName('Welcome to Hupa');

      expect(result).toBe('Welcome to MyCompany');
    });

    it('should replace multiple occurrences of "Hupa"', () => {
      const { replaceInstallationName } = useBranding();
      const result = replaceInstallationName(
        'Hupa is great! Use Hupa today.'
      );
    ...
    it('should return original text when installation name is not provided', () => {
      ...
      expect(result).toBe('Welcome to Hupa');
    });
    ...
    it('should handle text without "Hupa" gracefully', () => {
      const { replaceInstallationName } = useBranding();
    ...
    it('should be case-sensitive for "Hupa"', () => {
      const { replaceInstallationName } = useBranding();
      const result = replaceInstallationName(
        'Welcome to Hupa and Hupa'
      );

      expect(result).toBe('Welcome to Hupa and Hupa');
    });

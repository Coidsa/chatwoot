...
describe Whatsapp::IncomingMessageService do
  describe '#perform' do
    ...
    # ref: https://github.com/hupa/hupa/issues/3795#issuecomment-1018057318
    ...
    context 'when valid contact message params' do
      it 'creates appropriate message and attachments' do
        params = { 'contacts' => [{ 'profile' => { 'name' => 'Kedar' }, 'wa_id' => '919746334593' }],
                   'messages' => [{ 'from' => '919446284490',
                                    ...
                                    'contacts' => [
                                      ...
                                      { 'name' => { 'first_name' => 'hupa', 'formatted_name' => 'hupa' },
        ...
        expect(m2.content).to eq('hupa')
        expect(m2.attachments.first.meta).to eq({ 'firstName' => 'hupa' })
      end
    end

    # ref: https://github.com/hupa/hupa/issues/5840
